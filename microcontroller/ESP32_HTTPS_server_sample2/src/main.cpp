...
void task4(void *pvparameter)
{
    while (true)
    {
        ...
        doc["APIKey"] =
            "OoDUEAxaDLE3L+tdG2ZWmvSNJ8A5jnzh9a4r4d4XzEw="; //    /vyDA/OWuDLOHMrbN+Dso7tONCfjiNRKnnNd4FqTEQA=";
        doc["Action"] = 1;
        ...
        uint8_t valid_fingerprint[32] = {0x90, 0xC4, 0x9F, 0xE3, 0xD4, 0x82, 0x78, 0xEE, 0x7E, 0x3,  0xD7,
                                         0xE9, 0x1,  0x2C, 0x2D, 0x10, 0xCF, 0x8D, 0x27, 0x88, 0xF0, 0x20,
                                         0x31, 0x4D, 0xF9, 0x51, 0xF8, 0xF8, 0xA4, 0x15, 0xBF, 0xC7};
...
void setup()
{
    ...
    xTaskCreatePinnedToCore(task1, "Task 1", 2048,
                            NULL, // task parameters
                            1,    // task priority
                            NULL, // task handle
                            0     // core 1
    );
    xTaskCreatePinnedToCore(task2, "Task 2", 2048,
                            NULL, // task parameters
                            1,    // task priority
                            NULL, // task handle
                            0     // core 1
    ...
    xTaskCreatePinnedToCore(task3, "Task 3", 2048,
                            NULL, // task parameters
                            1,    // task priority
                            NULL, // task handle
                            0     // core 2
    ...
    xTaskCreatePinnedToCore(task4, "Task 4", 4096 * 2,
                            NULL, // task parameters
                            1,    // task priority
                            NULL, // task handle
                            1     // core 2
    ...
    xTaskCreatePinnedToCore(buttonPushedTask, "Task 5", 4096,
                            NULL, // task parameters
                            1,    // task priority
                            NULL, // task handle
                            0     // core 1
